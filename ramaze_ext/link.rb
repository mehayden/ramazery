  ...
  module Helper
    ...
    module Link
      def route_location(klass)
        # The following line ensures we are in the context of a Node.
        # If called from a template context, this will operate on the
        # current action's Node object.
        return route_location(Innate::Current.action.node) unless klass.is_a?(Innate::Node)
